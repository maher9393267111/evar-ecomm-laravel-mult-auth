                        ...
                        <div class="card-body">
                            ...
                            <form action="{{route('shipping.update',$shipping->id)}}" method="POST">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" placeholder="Type here" class="form-control" name="shipping_address" id="product_name" value="{{$shipping->shipping_address}}">
                                </div>                        
                                <div class="mb-4">
                                    <label class="form-label">Delivery Time</label>
                                    <input type="text" placeholder="Type here" class="form-control" name="delivery_time" id="product_name" value="{{$shipping->delivery_time}}">
                                </div>
                                <div class="mb-4">
                                    <label class="form-label">Delivery Charges</label>
                                    <input type="number" placeholder="Type here" class="form-control" step="any" name="delivery_charges" id="product_name" value="{{$shipping->delivery_charges}}">
                                </div>                              
