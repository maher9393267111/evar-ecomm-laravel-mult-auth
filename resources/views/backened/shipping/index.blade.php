...
<section class="content-main">
 ...
 <div class="col-lg-12">
            ...
            <div class="content-header">
                <div>
                    <h2 class="content-title card-title">Shipping Data </h2>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <a href="{{route('shipping.edit',$item->id)}}" data-toggle="tooltip" title="edit" class="float-left btn  btn-outline-warning" data-placment="bottom" style="float:left;"><i class="icon material-icons md-edit"></i></a>
        <form style="float:left;margin-left: 10px;" action="{{route('shipping.destroy',$item->id)}}" method="POST">
          @csrf
          @method('delete')
