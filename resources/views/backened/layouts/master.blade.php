...
<head>
    @include('backened.layouts.header')
</head>
    ...
    <aside class="navbar-aside" id="offcanvas_aside">
        <div class="aside-top">
            <a href="index.html" class="brand-wrap">
                <img src="{{asset('backend/assets/imgs/theme/logo.svg')}}" class="logo" alt="Admin Dashboard">
            </a>
            <div>
                ...
                <ul class="nav">
                    ...
                    <li class="dropdown nav-item">
                        ...
                        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownAccount">
                            ...
                            <a class="dropdown-item text-danger" ><a class="dropdown-item" href="{{ route('logout') }}"
