                ...
                <div class="container">
                    <div class="slider-1-height-2 slider-animated-1">
                        <div class="hero-slider-content-2">
                            <h5 class="animated  fw-900"> {{$banner->title}}</h5>
                            <!-- <h3 class="animated"></h3>
                                <h3 class="animated fw-900 text-brand"></h3>  -->
                        ...
                        <div class="single-slider-img single-slider-img-1">
                            <img class="animated" src="{{$banner->photo}}" alt="">
                        </div>
                    </div>
                </div>
            </div>
            ...
            @foreach($categories as $cat)
                <div class="col-lg-4 col-md-6">
                    <div class="banner-img wow fadeIn animated">
                        <img src="{{$cat->photo}}" alt="{{$cat->title}}" style="widht: 376px;height:160px;">
                        <div class="banner-text">
                            <span>{{$cat->title}}</span>
                            <h5>{{$cat->summary}}</h5>
                            <a href="{{route('product.category',$cat->slug)}}">Shop Now <i class="fi-rs-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
            @endforeach
                                ...
                                <div class="col-lg-4 col-md-4 col-12 col-sm-6">
                                    <div class="product-cart-wrap mb-30">
                                        <div class="product-img-action-wrap">
                                            <div class="product-img product-img-zoom">
                                                <a href="shop-product-right.html">
                                                    <img class="hover-img" src="assets/imgs/shop/product-13-1.jpg" alt="">
                                                    <img class="default-img" src="assets/imgs/shop/product-13-2.jpg" alt="">
                                                </a>
                                            </div>
                                            <div class="product-action-1">
                                                <a aria-label="Quick view" class="action-btn hover-up" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i class="fi-rs-eye"></i></a>
    ...
    <section class="banner-2 section-padding pb-0">
        <div class="container">
            <div class="banner-img banner-big wow fadeIn animated f-none">
                <img src="frontend/assets/imgs/banner/banner-4.png" alt="">
                ...
                <div class="carausel-6-columns" id="carausel-6-columns">
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img src="frontend/assets/imgs/shop/category-thumb-1.jpg" alt=""></a>
                        </figure>
                        <h5><a href="shop-grid-right.html">T-Shirt</a></h5>
                    </div>
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"> <img src="frontend/assets/imgs/shop/category-thumb-2.jpg" alt=""></a>
                        </figure>
                        <h5><a href="shop-grid-right.html">Bags</a></h5>
                    </div>
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img src="frontend/assets/imgs/shop/category-thumb-3.jpg" alt=""></a>
                        </figure>
                        <h5><a href="shop-grid-right.html">Sandan</a></h5>
                    </div>
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img src="frontend/assets/imgs/shop/category-thumb-4.jpg" alt=""></a>
                        </figure>
                        <h5><a href="shop-grid-right.html">Scarf Cap</a></h5>
                    </div>
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img src="frontend/assets/imgs/shop/category-thumb-5.jpg" alt=""></a>
                        </figure>
                        <h5><a href="shop-grid-right.html">Shoes</a></h5>
                    </div>
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img src="frontend/assets/imgs/shop/category-thumb-6.jpg" alt=""></a>
                        </figure>
                        <h5><a href="shop-grid-right.html">Pillowcase</a></h5>
                    </div>
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img src="frontend/assets/imgs/shop/category-thumb-7.jpg" alt=""></a>
                        </figure>
                        <h5><a href="shop-grid-right.html">Jumpsuits</a></h5>
                    </div>
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img src="frontend/assets/imgs/shop/category-thumb-8.jpg" alt=""></a>
                        </figure>
                    ...
                    <div class="product-cart-wrap small hover-up">
                        <div class="product-img-action-wrap">
                            <div class="product-img product-img-zoom">
                                ...
                                @endphp
                                <a href="shop-product-right.html">
                                    <img class="default-img" src="{{$photo[0]}}" alt="{{$products->title}}">
                                    <!-- <img class="hover-img" src="assets/imgs/shop/product-2-2.jpg" alt=""> -->
                                </a>
                            </div>
                            <div class="product-action-1">
                                ...
                                <a aria-label="Add To Wishlist" class="action-btn hover-up add_to_wishlist" data-quantity="1" data-id="{{$products->id}}" id="add_to_wishlist_{{$products->id}}" href="javascript:void(0);"  tabindex="0"><i class="fi-rs-heart"></i></a>
                                <a aria-label="Compare" class="action-btn small hover-up" href="shop-compare.html" tabindex="0"><i class="fi-rs-shuffle"></i></a>
                            </div>
                            <div class="product-badges product-badges-position product-badges-mrg">
                                <span class="hot">{{$products->conditions}}</span>
                            </div>
                        </div>
                        <div class="product-content-wrap">
                            <h2><a href="{{route('product.detail',$products->slug)}}">{{ucfirst($products->title)}}</a></h2>
                            <div class="rating-result" title="90%">
                                <span>
                                </span>
                            </div>
                            <div class="product-price">
                                <span>${{number_format($products->offer_price,2)}} </span>
                                <span class="old-price">${{number_format($products->price,2)}}}</span>
                            </div>
                        </div>
                    </div>
