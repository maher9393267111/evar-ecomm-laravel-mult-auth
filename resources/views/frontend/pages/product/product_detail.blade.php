                        ...
                        <div class="product-detail accordion-detail">
                            <div class="row mb-50">
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    @endphp
                                        ...
                                        @foreach($photos as $key=>$photo )
                                            <div><img src="{{$photo}}" alt="{{$product->title}}"></div>
                                            @endforeach
                                    ...
                                    <div class="detail-info">
                                        ...
                                        <div class="product-detail-rating">
                                            <div class="pro-details-brand">
                                                <span> Brands: <a href="shop-grid-right.html">{{\App\Models\Brand::where('id',$product->brand_id)->value('title')}}</a></span>
                                            </div>
                                        ...
                                        <div class="clearfix product-price-cover">
                                            <div class="product-price primary-color float-left">
                                                <ins><span class="text-brand">${{number_format($product->offer_price,2)}}</span></ins>
                            ...
                            <div class="row mt-60">
                                ...
                                <div class="col-12">
                                    ...
                                    @foreach($product->rel_product as $item)
...
"><i class="fi-rs-search"></i></a>
                                                ...
                                                <div class="product-content-wrap">
                                                    <h2><a href="{{route('product.detail',$item->slug)}}" tabindex="0">{{$item->title}}</a></h2>
