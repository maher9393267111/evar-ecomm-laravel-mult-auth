...
class CategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backened.category.index',compact('category'));
    }
    ...
    public function create()
    {
        ...
        return view('backened.category.create',compact('parent_cats'));
    }
    ...
    public function edit($id)
    {
        ...
        $parent_cats=Category::where('is_parent',1)->orderBy('title','ASC')->get();
        if($category){
            return view('backened.category.edit',compact(['category','parent_cats']));
        }
        else{
